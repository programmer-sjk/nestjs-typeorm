...
// describe('MovieService Mock Test', () => {
...
//     // given
//     const request = MovieTestFactory.createRequest('us and them');
//     const movie = MovieTestFactory.create();
//     jest.spyOn(movieRepository, 'save').mockImplementation(() => movie);
